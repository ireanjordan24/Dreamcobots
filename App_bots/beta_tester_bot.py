"""
BetaTesterBot — beta tester recruiter and manager.
...
class BetaTesterBotTierError(Exception):
...
class BetaTesterBot:
    """Tier-aware beta tester recruiter and manager."""
    ...
    def list_items(self, limit: Optional[int] = None) -> List[Dict[str, Any]]:
        """Return a list of beta_tester_bot items up to the tier limit."""
        self._usage_count += 1
    ...
    def get_top_item(self) -> Dict[str, Any]:
        """Return the highest-value beta_tester_bot item."""
        self._usage_count += 1
