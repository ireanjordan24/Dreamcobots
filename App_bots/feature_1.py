"""
OnboardingBot — user onboarding flow optimizer.
...
class OnboardingBotTierError(Exception):
...
class OnboardingBot:
    """Tier-aware user onboarding flow optimizer."""
