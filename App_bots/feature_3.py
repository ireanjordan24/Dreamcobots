"""
NotificationBot — smart push-notification bot.
...
class NotificationBotTierError(Exception):
...
class NotificationBot:
    """Tier-aware smart push-notification bot."""
    ...
    def _enforce_tier(self, required_value: str) -> None:
        ...
        if order.index(self.tier.value) < order.index(required_value):
            raise NotificationBotTierError(
