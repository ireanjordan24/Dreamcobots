"""
AnalyticsBot — in-app analytics aggregator.
...
class AnalyticsBotTierError(Exception):
...
class AnalyticsBot:
    """Tier-aware in-app analytics aggregator."""
    ...
    def list_items(self, limit: Optional[int] = None) -> List[Dict[str, Any]]:
        """Return a list of analytics_bot items up to the tier limit."""
        self._usage_count += 1
    ...
    def get_top_item(self) -> Dict[str, Any]:
        """Return the highest-value analytics_bot item."""
        self._usage_count += 1
