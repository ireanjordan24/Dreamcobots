"""
ABTestingBot — A/B test experiment manager.
...
class ABTestingBotTierError(Exception):
...
class ABTestingBot:
    """Tier-aware A/B test experiment manager."""
    ...
    def list_items(self, limit: Optional[int] = None) -> List[Dict[str, Any]]:
        """Return a list of ab_testing_bot items up to the tier limit."""
        self._usage_count += 1
    ...
    def get_top_item(self) -> Dict[str, Any]:
        """Return the highest-value ab_testing_bot item."""
        self._usage_count += 1
