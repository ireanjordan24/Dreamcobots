"""
DeepLinkBot — deep link generator and tracker.
...
class DeepLinkBotTierError(Exception):
...
class DeepLinkBot:
    """Tier-aware deep link generator and tracker."""
    ...
    def list_items(self, limit: Optional[int] = None) -> List[Dict[str, Any]]:
        """Return a list of deep_link_bot items up to the tier limit."""
        self._usage_count += 1
    ...
    def get_top_item(self) -> Dict[str, Any]:
        """Return the highest-value deep_link_bot item."""
        self._usage_count += 1
