"""
FeatureFlagBot — feature flag and rollout manager.
...
class FeatureFlagBotTierError(Exception):
...
class FeatureFlagBot:
    """Tier-aware feature flag and rollout manager."""
    ...
    def list_items(self, limit: Optional[int] = None) -> List[Dict[str, Any]]:
        """Return a list of feature_flag_bot items up to the tier limit."""
        self._usage_count += 1
    ...
    def get_top_item(self) -> Dict[str, Any]:
        """Return the highest-value feature_flag_bot item."""
        self._usage_count += 1
