...
class RoboAdvisor:
    ...
    def profile_risk(self, answers: dict) -> dict:
        ...
        score = (
            answers.get("risk_tolerance", 3) * 20
            + answers.get("time_horizon", 3) * 10
            - answers.get("income_volatility", 2) * 5
        )
        profile = (
            "aggressive" if score > 80 else "moderate" if score > 50 else "conservative"
        )
