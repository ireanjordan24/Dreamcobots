"""
ViewingSchedulerBot — property viewing scheduler.
...
class ViewingSchedulerBotTierError(Exception):
...
class ViewingSchedulerBot:
    """Tier-aware property viewing scheduler."""
    ...
    def _enforce_tier(self, required_value: str) -> None:
        ...
        if order.index(self.tier.value) < order.index(required_value):
            raise ViewingSchedulerBotTierError(
