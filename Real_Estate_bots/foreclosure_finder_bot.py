"""
ForeclosureFinderBot — foreclosure property finder.
...
class ForeclosureFinderBot:
    """Tier-aware foreclosure property finder."""
    ...
    def list_items(self, limit: Optional[int] = None) -> List[Dict[str, Any]]:
        """Return a list of foreclosure_finder_bot items up to the tier limit."""
        self._usage_count += 1
    ...
    def get_top_item(self) -> Dict[str, Any]:
        """Return the highest-value foreclosure_finder_bot item."""
        self._usage_count += 1
