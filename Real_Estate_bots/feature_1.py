"""
PropertyListingsBot — property listings aggregator.
...
class PropertyListingsBotTierError(Exception):
...
class PropertyListingsBot:
    """Tier-aware property listings aggregator."""
    ...
    def _enforce_tier(self, required_value: str) -> None:
        ...
        if order.index(self.tier.value) < order.index(required_value):
            raise PropertyListingsBotTierError(
