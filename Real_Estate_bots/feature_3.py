...
EXAMPLES = [
    ...
    },
    {
        ...
        "state": "AZ",
        "median_price": 410000,
        "price_change_yoy_pct": 4.8,
        "inventory_months": 2.8,
        "days_on_market": 22,
        "price_per_sqft": 210,
        "cap_rate_avg_pct": 5.2,
    ...
    },
    {
        ...
        "state": "TN",
        "median_price": 455000,
        "price_change_yoy_pct": 5.5,
        "inventory_months": 1.9,
        "days_on_market": 15,
        "price_per_sqft": 260,
        "cap_rate_avg_pct": 5.0,
    ...
    },
    {
        ...
        "state": "FL",
        "median_price": 395000,
        "price_change_yoy_pct": 7.1,
        "inventory_months": 2.5,
        "days_on_market": 20,
        "price_per_sqft": 230,
        "cap_rate_avg_pct": 5.5,
        "population_growth_pct": 3.4,
    },
    {
        "id": 6,
        "city": "Charlotte",
        "state": "NC",
        "median_price": 375000,
        "price_change_yoy_pct": 5.9,
        "inventory_months": 2.2,
        "days_on_market": 17,
        "price_per_sqft": 218,
        "cap_rate_avg_pct": 5.3,
        "population_growth_pct": 2.9,
    },
    {
        "id": 7,
        "city": "Atlanta",
        "state": "GA",
        "median_price": 400000,
        "price_change_yoy_pct": 4.4,
        "inventory_months": 2.7,
        "days_on_market": 24,
        "price_per_sqft": 225,
        "cap_rate_avg_pct": 4.9,
    ...
    },
    {
        ...
        "state": "TX",
        "median_price": 340000,
        "price_change_yoy_pct": 3.1,
        "inventory_months": 3.4,
        "days_on_market": 30,
        "price_per_sqft": 190,
        "cap_rate_avg_pct": 5.4,
    ...
    },
    {
        ...
        "state": "NV",
        "median_price": 420000,
        "price_change_yoy_pct": 4.9,
        "inventory_months": 2.6,
        "days_on_market": 21,
        "price_per_sqft": 220,
        "cap_rate_avg_pct": 4.7,
    ...
    },
    {
        ...
        "days_on_market": 14,
        "price_per_sqft": 240,
        "cap_rate_avg_pct": 5.1,
        "population_growth_pct": 3.3,
    },
    {
        "id": 12,
        "city": "Orlando",
        "state": "FL",
        "median_price": 380000,
        "price_change_yoy_pct": 6.4,
        "inventory_months": 2.3,
        "days_on_market": 19,
        "price_per_sqft": 225,
        "cap_rate_avg_pct": 5.6,
    ...
    },
    {
        ...
        "state": "TX",
        "median_price": 295000,
        "price_change_yoy_pct": 4.1,
        "inventory_months": 2.9,
        "days_on_market": 25,
        "price_per_sqft": 180,
        "cap_rate_avg_pct": 5.8,
        "population_growth_pct": 2.2,
    },
    {
        "id": 14,
        "city": "Indianapolis",
    ...
    },
    {
        ...
        "state": "OH",
        "median_price": 285000,
        "price_change_yoy_pct": 4.7,
        "inventory_months": 2.6,
        "days_on_market": 22,
        "price_per_sqft": 170,
        "cap_rate_avg_pct": 5.9,
        "population_growth_pct": 1.7,
    },
    {
        "id": 16,
        "city": "Salt Lake City",
        "state": "UT",
        "median_price": 510000,
        "price_change_yoy_pct": 3.5,
        "inventory_months": 3.2,
        "days_on_market": 27,
        "price_per_sqft": 275,
        "cap_rate_avg_pct": 4.3,
        "population_growth_pct": 2.6,
    },
    {
        "id": 17,
        "city": "Jacksonville",
        "state": "FL",
        "median_price": 335000,
        "price_change_yoy_pct": 5.8,
        "inventory_months": 2.5,
        "days_on_market": 21,
        "price_per_sqft": 195,
        "cap_rate_avg_pct": 5.7,
    ...
    },
    {
        ...
        "state": "TN",
        "median_price": 230000,
        "price_change_yoy_pct": 4.3,
        "inventory_months": 2.7,
        "days_on_market": 24,
        "price_per_sqft": 145,
        "cap_rate_avg_pct": 7.1,
    ...
    },
    {
        ...
        "state": "KY",
        "median_price": 255000,
        "price_change_yoy_pct": 4.6,
        "inventory_months": 2.8,
        "days_on_market": 23,
        "price_per_sqft": 155,
        "cap_rate_avg_pct": 6.0,
    ...
    },
    {
        ...
        "state": "OK",
        "median_price": 235000,
        "price_change_yoy_pct": 3.9,
        "inventory_months": 3.1,
        "days_on_market": 27,
        "price_per_sqft": 140,
        "cap_rate_avg_pct": 6.4,
        "population_growth_pct": 1.3,
    },
    {
        "id": 22,
        "city": "Kansas City",
    ...
    },
    {
        ...
        "state": "MN",
        "median_price": 370000,
        "price_change_yoy_pct": 2.8,
        "inventory_months": 3.5,
        "days_on_market": 31,
        "price_per_sqft": 205,
        "cap_rate_avg_pct": 4.5,
    ...
    },
    {
        ...
        "state": "PA",
        "median_price": 230000,
        "price_change_yoy_pct": 3.3,
        "inventory_months": 3.3,
        "days_on_market": 29,
        "price_per_sqft": 145,
        "cap_rate_avg_pct": 6.5,
    ...
    },
    {
        ...
        "state": "ID",
        "median_price": 465000,
        "price_change_yoy_pct": 5.4,
        "inventory_months": 2.4,
        "days_on_market": 20,
        "price_per_sqft": 265,
        "cap_rate_avg_pct": 4.4,
        "population_growth_pct": 4.1,
    },
    {
        "id": 27,
        "city": "Spokane",
...
class MarketAnalysisBot:
    ...
    def get_market_overview(self, city: str) -> dict:
        ...
        if market is None:
            raise ValueError(
                f"City '{city}' not found. Available: {[m['city'] for m in EXAMPLES]}"
            )
        result = dict(market)
        result["market_type"] = (
            "Seller's" if market["inventory_months"] < 3 else "Buyer's"
        )
        result["investment_grade"] = self._grade_market(market)
        if self._config["forecasting"]:
            result["forecast_12mo_price_change_pct"] = round(
                market["price_change_yoy_pct"] * 0.9, 1
            )
            result["forecast_24mo_price_change_pct"] = round(
                market["price_change_yoy_pct"] * 1.7, 1
            )
        return result
    ...
    def get_top_investment_markets(self, count: int = 5) -> list[dict]:
        ...
        scored = [{**m, "investment_score": self._score_market(m)} for m in markets]
    ...
    def get_fastest_growing_markets(self, count: int = 5) -> list[dict]:
        ...
        markets = sorted(
            self._get_markets(), key=lambda m: m["price_change_yoy_pct"], reverse=True
        )
    ...
    def run(self) -> dict:
        ...
        result = self._flow.run_pipeline(
            raw_data={
                "domain": "real_estate_market_analysis",
                "markets_count": len(EXAMPLES),
            },
...
if __name__ == "__main__":
    ...
    for m in top:
        print(
            f"  {m['city']}, {m['state']} — Score: {m['investment_score']} — Cap Rate: {m['cap_rate_avg_pct']}%"
        )
...
def _marketanalysis_bot_monthly_price(self):
    return _TIER_MONTHLY_PRICE[
        self.tier.value if hasattr(self.tier, "value") else self.tier.lower()
    ]
