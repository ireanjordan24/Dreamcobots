"""
ROITrackerBot — return on investment tracker.
...
class ROITrackerBotTierError(Exception):
...
class ROITrackerBot:
    """Tier-aware return on investment tracker."""
    ...
    def list_items(self, limit: Optional[int] = None) -> List[Dict[str, Any]]:
        """Return a list of roi_tracker_bot items up to the tier limit."""
        self._usage_count += 1
    ...
    def get_top_item(self) -> Dict[str, Any]:
        """Return the highest-value roi_tracker_bot item."""
        self._usage_count += 1
