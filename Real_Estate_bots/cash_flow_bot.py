"""
CashFlowBot — rental cash flow calculator.
...
class CashFlowBotTierError(Exception):
...
class CashFlowBot:
    """Tier-aware rental cash flow calculator."""
    ...
    def list_items(self, limit: Optional[int] = None) -> List[Dict[str, Any]]:
        """Return a list of cash_flow_bot items up to the tier limit."""
        self._usage_count += 1
    ...
    def get_top_item(self) -> Dict[str, Any]:
        """Return the highest-value cash_flow_bot item."""
        self._usage_count += 1
