"""
FixAndFlipBot — fix-and-flip project tracker.
...
class FixAndFlipBotTierError(Exception):
...
class FixAndFlipBot:
    """Tier-aware fix-and-flip project tracker."""
    ...
    def list_items(self, limit: Optional[int] = None) -> List[Dict[str, Any]]:
        """Return a list of fix_and_flip_bot items up to the tier limit."""
        self._usage_count += 1
    ...
    def get_top_item(self) -> Dict[str, Any]:
        """Return the highest-value fix_and_flip_bot item."""
        self._usage_count += 1
