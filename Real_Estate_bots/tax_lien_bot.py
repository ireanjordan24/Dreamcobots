"""
TaxLienBot — tax lien certificate finder.
...
class TaxLienBotTierError(Exception):
...
class TaxLienBot:
    """Tier-aware tax lien certificate finder."""
    ...
    def list_items(self, limit: Optional[int] = None) -> List[Dict[str, Any]]:
        """Return a list of tax_lien_bot items up to the tier limit."""
        self._usage_count += 1
    ...
    def get_top_item(self) -> Dict[str, Any]:
        """Return the highest-value tax_lien_bot item."""
        self._usage_count += 1
