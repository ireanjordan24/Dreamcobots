"""
PitchDeckBot — investor pitch deck generator.
...
class PitchDeckBotTierError(Exception):
...
class PitchDeckBot:
    """Tier-aware investor pitch deck generator."""
    ...
    def list_items(self, limit: Optional[int] = None) -> List[Dict[str, Any]]:
        """Return a list of pitch_deck_bot items up to the tier limit."""
        self._usage_count += 1
    ...
    def get_top_item(self) -> Dict[str, Any]:
        """Return the highest-value pitch_deck_bot item."""
        self._usage_count += 1
