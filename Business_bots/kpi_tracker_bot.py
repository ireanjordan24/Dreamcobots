"""
KPITrackerBot — KPI and metrics tracker.
...
class KPITrackerBotTierError(Exception):
...
class KPITrackerBot:
    """Tier-aware KPI and metrics tracker."""
    ...
    def list_items(self, limit: Optional[int] = None) -> List[Dict[str, Any]]:
        """Return a list of kpi_tracker_bot items up to the tier limit."""
        self._usage_count += 1
    ...
    def get_top_item(self) -> Dict[str, Any]:
        """Return the highest-value kpi_tracker_bot item."""
        self._usage_count += 1
