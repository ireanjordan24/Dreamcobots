"""
PayrollBot — automated payroll calculator.
...
class PayrollBotTierError(Exception):
...
class PayrollBot:
    """Tier-aware automated payroll calculator."""
    ...
    def list_items(self, limit: Optional[int] = None) -> List[Dict[str, Any]]:
        """Return a list of payroll_bot items up to the tier limit."""
        self._usage_count += 1
    ...
    def get_top_item(self) -> Dict[str, Any]:
        """Return the highest-value payroll_bot item."""
        self._usage_count += 1
