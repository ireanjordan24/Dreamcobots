"""
GrantFinderBot — business grant finder.
...
class GrantFinderBotTierError(Exception):
...
class GrantFinderBot:
    """Tier-aware business grant finder."""
    ...
    def list_items(self, limit: Optional[int] = None) -> List[Dict[str, Any]]:
        """Return a list of grant_finder_bot items up to the tier limit."""
        self._usage_count += 1
    ...
    def get_top_item(self) -> Dict[str, Any]:
        """Return the highest-value grant_finder_bot item."""
        self._usage_count += 1
