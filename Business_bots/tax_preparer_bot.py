"""
TaxPreparerBot — small business tax preparer.
...
class TaxPreparerBotTierError(Exception):
...
class TaxPreparerBot:
    """Tier-aware small business tax preparer."""
    ...
    def list_items(self, limit: Optional[int] = None) -> List[Dict[str, Any]]:
        """Return a list of tax_preparer_bot items up to the tier limit."""
        self._usage_count += 1
    ...
    def get_top_item(self) -> Dict[str, Any]:
        """Return the highest-value tax_preparer_bot item."""
        self._usage_count += 1
