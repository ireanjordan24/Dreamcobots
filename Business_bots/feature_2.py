...
EXAMPLES = [
    ...
    },
    {
        ...
        "status": "in_progress",
        "budget_usd": 22000,
        "tags": ["partnerships", "web"],
    },
    {
        "id": 13,
        "name": "Q3 OKR Planning",
        "owner": "Mary",
        "team": ["CEO", "Leadership1"],
        "deadline": "2025-06-05",
        "progress_pct": 60,
        "priority": "high",
        "status": "review",
    ...
    {
        "id": 23,
        "name": "Social Media Strategy 2025",
        "owner": "Wendy",
        "team": ["Mkt4", "Content3"],
        "deadline": "2025-05-20",
        "progress_pct": 100,
...
class ProjectManagementBot:
    ...
    def get_at_risk_projects(self, threshold_pct: int = 50) -> list[dict]:
        ...
        return [
            p
            for p in self._available_projects()
    ...
    def get_budget_summary(self) -> dict:
        ...
        return {
            ...
            "projects_over_50pct_budget": [
                p["name"]
                for p in projects
                if p["progress_pct"] > 50 and p["budget_usd"] > 0
            ],
        }
    ...
    def get_ai_priority_score(self, project_id: int) -> dict:
        ...
        return {
            ...
            "recommendation": (
                "Focus immediately"
                if score >= 70
                else "On track" if score >= 40 else "Low priority"
            ),
        }
    ...
    def get_dashboard(self) -> dict:
        ...
        avg_progress = (
            round(sum(p["progress_pct"] for p in projects) / len(projects), 1)
            if projects
            else 0
        )
        return {
...
if __name__ == "__main__":
    ...
    print(
        f"Projects: {dashboard['total_projects']} total | {dashboard['in_progress']} in progress | {dashboard['completed']} completed"
    )
