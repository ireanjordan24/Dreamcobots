"""
WebinarBot — webinar promotion and registration bot.
...
class WebinarBotTierError(Exception):
...
class WebinarBot:
    """Tier-aware webinar promotion and registration bot."""
    ...
    def list_items(self, limit: Optional[int] = None) -> List[Dict[str, Any]]:
        """Return a list of webinar_bot items up to the tier limit."""
        self._usage_count += 1
    ...
    def get_top_item(self) -> Dict[str, Any]:
        """Return the highest-value webinar_bot item."""
        self._usage_count += 1
