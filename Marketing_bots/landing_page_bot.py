"""
LandingPageBot — landing page conversion optimizer.
...
class LandingPageBotTierError(Exception):
...
class LandingPageBot:
    """Tier-aware landing page conversion optimizer."""
    ...
    def list_items(self, limit: Optional[int] = None) -> List[Dict[str, Any]]:
        """Return a list of landing_page_bot items up to the tier limit."""
        self._usage_count += 1
    ...
    def get_top_item(self) -> Dict[str, Any]:
        """Return the highest-value landing_page_bot item."""
        self._usage_count += 1
