"""
ContentCreationBot — AI content creation bot.
...
class ContentCreationBotTierError(Exception):
...
class ContentCreationBot:
    """Tier-aware AI content creation bot."""
    ...
    def _enforce_tier(self, required_value: str) -> None:
        ...
        if order.index(self.tier.value) < order.index(required_value):
            raise ContentCreationBotTierError(
