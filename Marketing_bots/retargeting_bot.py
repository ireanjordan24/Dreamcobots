"""
RetargetingBot — ad retargeting strategy bot.
...
class RetargetingBotTierError(Exception):
...
class RetargetingBot:
    """Tier-aware ad retargeting strategy bot."""
    ...
    def list_items(self, limit: Optional[int] = None) -> List[Dict[str, Any]]:
        """Return a list of retargeting_bot items up to the tier limit."""
        self._usage_count += 1
    ...
    def get_top_item(self) -> Dict[str, Any]:
        """Return the highest-value retargeting_bot item."""
        self._usage_count += 1
