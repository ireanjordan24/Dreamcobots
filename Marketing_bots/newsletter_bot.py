"""
NewsletterBot — newsletter content bot.
...
class NewsletterBotTierError(Exception):
...
class NewsletterBot:
    """Tier-aware newsletter content bot."""
    ...
    def list_items(self, limit: Optional[int] = None) -> List[Dict[str, Any]]:
        """Return a list of newsletter_bot items up to the tier limit."""
        self._usage_count += 1
    ...
    def get_top_item(self) -> Dict[str, Any]:
        """Return the highest-value newsletter_bot item."""
        self._usage_count += 1
