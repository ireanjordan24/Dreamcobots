"""
SocialProofBot — social proof aggregator.
...
class SocialProofBotTierError(Exception):
...
class SocialProofBot:
    """Tier-aware social proof aggregator."""
    ...
    def list_items(self, limit: Optional[int] = None) -> List[Dict[str, Any]]:
        """Return a list of social_proof_bot items up to the tier limit."""
        self._usage_count += 1
    ...
    def get_top_item(self) -> Dict[str, Any]:
        """Return the highest-value social_proof_bot item."""
        self._usage_count += 1
