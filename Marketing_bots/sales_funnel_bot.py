"""
SalesFunnelBot — sales funnel builder and optimizer.
...
class SalesFunnelBotTierError(Exception):
...
class SalesFunnelBot:
    """Tier-aware sales funnel builder and optimizer."""
    ...
    def list_items(self, limit: Optional[int] = None) -> List[Dict[str, Any]]:
        """Return a list of sales_funnel_bot items up to the tier limit."""
        self._usage_count += 1
    ...
    def get_top_item(self) -> Dict[str, Any]:
        """Return the highest-value sales_funnel_bot item."""
        self._usage_count += 1
