"""
EmailMarketingBot — email marketing campaign manager.
...
class EmailMarketingBotTierError(Exception):
...
class EmailMarketingBot:
    """Tier-aware email marketing campaign manager."""
    ...
    def _enforce_tier(self, required_value: str) -> None:
        ...
        if order.index(self.tier.value) < order.index(required_value):
            raise EmailMarketingBotTierError(
