"""
GoogleAdsBot — Google Ads campaign optimizer.
...
class GoogleAdsBotTierError(Exception):
...
class GoogleAdsBot:
    """Tier-aware Google Ads campaign optimizer."""
    ...
    def list_items(self, limit: Optional[int] = None) -> List[Dict[str, Any]]:
        """Return a list of google_ads_bot items up to the tier limit."""
        self._usage_count += 1
    ...
    def get_top_item(self) -> Dict[str, Any]:
        """Return the highest-value google_ads_bot item."""
        self._usage_count += 1
