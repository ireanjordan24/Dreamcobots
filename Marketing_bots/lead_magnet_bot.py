"""
LeadMagnetBot — lead magnet creator.
...
class LeadMagnetBotTierError(Exception):
...
class LeadMagnetBot:
    """Tier-aware lead magnet creator."""
    ...
    def list_items(self, limit: Optional[int] = None) -> List[Dict[str, Any]]:
        """Return a list of lead_magnet_bot items up to the tier limit."""
        self._usage_count += 1
    ...
    def get_top_item(self) -> Dict[str, Any]:
        """Return the highest-value lead_magnet_bot item."""
        self._usage_count += 1
