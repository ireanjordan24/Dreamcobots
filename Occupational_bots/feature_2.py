...
EXAMPLES = [
    {
        ...
        "template": "Results-driven Software Engineer with {years} years of experience building scalable {tech_stack} applications. Proven track record of delivering high-quality code on time.",
        "ats_score": 88,
        "industry": "technology",
    },
    {
        ...
        "section": "Professional Summary",
        "role": "Data Analyst",
        "template": "Detail-oriented Data Analyst with expertise in {tools}. Transformed complex datasets into actionable business insights that drove {metric} revenue growth.",
        "ats_score": 85,
        "industry": "analytics",
    },
    {
        ...
        "template": "Strategic Product Manager with {years} years leading cross-functional teams. Launched {products} successful products that achieved {metric} user adoption.",
        "ats_score": 90,
        "industry": "product",
    },
    {
        ...
        "template": "Creative Marketing Manager specializing in {channels}. Grew organic traffic by {metric}% and managed $500K+ in ad spend with {roi} ROAS.",
        "ats_score": 87,
        "industry": "marketing",
    },
    {
        ...
        "section": "Professional Summary",
        "role": "UX Designer",
        "template": "User-centered UX Designer with expertise in {tools}. Redesigned core product flows that improved user retention by {metric}%.",
        "ats_score": 84,
        "industry": "design",
    },
    {
        ...
        "role": "Software Engineer",
        "template": "• Developed and maintained {system} using {tech_stack}, improving performance by {metric}%\n• Led a team of {size} engineers to deliver {project} on time and under budget",
        "ats_score": 92,
        "industry": "technology",
    },
    {
        ...
        "section": "Work Experience",
        "role": "Data Analyst",
        "template": "• Built automated reporting pipelines using {tools}, reducing manual work by {hours} hours/week\n• Analyzed {dataset_size} records to identify revenue opportunities worth ${revenue}",
        "ats_score": 90,
        "industry": "analytics",
    },
    {
        ...
        "section": "Work Experience",
        "role": "Product Manager",
        "template": "• Defined and shipped {features} product features used by {users}K+ monthly active users\n• Increased conversion rate by {metric}% through A/B testing and user research",
        "ats_score": 93,
        "industry": "product",
    },
    {
        ...
        "template": "• Consistently exceeded quota by {pct}%, generating ${revenue} in annual recurring revenue\n• Managed {clients} accounts across {territory} territory",
        "ats_score": 91,
        "industry": "sales",
    },
    {
        ...
        "section": "Work Experience",
        "role": "Marketing Manager",
        "template": "• Launched email campaign series achieving {open_rate}% open rate and {ctr}% CTR\n• Managed {budget} marketing budget with {roi}x return on investment",
        "ats_score": 89,
        "industry": "marketing",
    },
    {
        ...
        "section": "Skills",
        "role": "Software Engineer",
        "template": "Programming Languages: Python, JavaScript, TypeScript, Java\nFrameworks: React, Node.js, Django, FastAPI\nDevOps: AWS, Docker, Kubernetes, CI/CD\nDatabases: PostgreSQL, MongoDB, Redis",
        "ats_score": 95,
        "industry": "technology",
    },
    {
        ...
        "section": "Skills",
        "role": "Data Analyst",
        "template": "Analytics: SQL, Python (Pandas, NumPy), R\nVisualization: Tableau, Power BI, Matplotlib\nDatabases: PostgreSQL, BigQuery, Redshift\nTools: Excel, Google Sheets, Jupyter",
        "ats_score": 93,
        "industry": "analytics",
    },
    {
    ...
    },
    {
        ...
        "section": "Education",
        "role": "all",
        "template": "{degree} in {field}, {university} — GPA {gpa} | {graduation_year}\nRelevant Coursework: {courses}\nActivities: {activities}",
        "ats_score": 87,
        "industry": "all",
    },
    {
        ...
        "role": "Software Engineer",
        "template": "• AWS Certified Solutions Architect — Associate (2024)\n• Google Cloud Professional Data Engineer (2024)\n• Meta Backend Developer Certificate (2023)",
        "ats_score": 91,
        "industry": "technology",
    },
    {
    ...
    },
    {
        ...
        "role": "all",
        "template": "• {year}: {award_name} — {reason}\n• {year}: {achievement} — recognized by {organization}",
        "ats_score": 89,
        "industry": "all",
    },
    {
        ...
        "template": "Certified Cybersecurity Analyst with expertise in {tools}. Detected and mitigated {threats} security threats, reducing organizational risk by {metric}%.",
        "ats_score": 90,
        "industry": "security",
    },
    {
        ...
        "template": "• Maintained {nrr}% net revenue retention across portfolio of {accounts} accounts\n• Reduced churn by {churn_reduction}% through proactive health monitoring and QBRs",
        "ats_score": 91,
        "industry": "saas",
    },
    {
        ...
        "template": "Quantitative Financial Analyst with {years} years in {sector}. Modeled ${portfolio}B in assets with {accuracy}% forecast accuracy.",
        "ats_score": 88,
        "industry": "finance",
    },
    {
        ...
        "template": "• Managed {headcount} FTE team across {locations} locations, achieving {metric}% operational efficiency\n• Reduced costs by ${savings}K through process optimization",
        "ats_score": 92,
        "industry": "operations",
    },
    {
        ...
        "section": "Skills",
        "role": "Financial Analyst",
        "template": "Financial Modeling: DCF, LBO, M&A, Comparable Analysis\nTools: Excel, Bloomberg, Capital IQ, Tableau\nProgramming: Python, VBA, SQL\nCertifications: CFA Level II, FRM",
        "ats_score": 93,
        "industry": "finance",
    },
    {
        "id": 27,
        "section": "Cover Letter Opening",
        "role": "all",
        "template": "I am excited to apply for the {position} role at {company}. With {years} years of experience in {domain}, I have consistently {achievement} and am eager to bring these skills to your team.",
        "ats_score": 85,
        "industry": "all",
    },
    {
        "id": 28,
        "section": "Cover Letter Closing",
        "role": "all",
        "template": "I would welcome the opportunity to discuss how my background in {domain} aligns with {company}'s vision. Thank you for your consideration — I look forward to speaking with you.",
        "ats_score": 84,
        "industry": "all",
    },
    {
        ...
        "role": "all",
        "template": "{tagline} | {role} at {company} | Helping {target_audience} achieve {outcome} | {keyword1} | {keyword2} | {keyword3}",
        "ats_score": 90,
        "industry": "all",
    },
    {
        ...
        "section": "References",
        "role": "all",
        "template": "References available upon request. Professional network includes {reference_types} from {companies}.",
        "ats_score": 75,
        "industry": "all",
    },
]
...
class ResumeBuildingBot:
    ...
    def get_templates_by_section(self, section: str) -> list[dict]:
        ...
        return [
            ...
            if t["section"].lower() == section.lower()
        ]
    ...
    def check_ats_score(self, template_id: int) -> dict:
        ...
        return {
            ...
            "ats_score": score,
            "grade": (
                "Excellent" if score >= 90 else "Good" if score >= 80 else "Needs Work"
            ),
            "tips": [
    ...
    def get_ai_suggestions(self, role: str, section: str) -> dict:
        ...
        matching = [
            t
            for t in EXAMPLES
            if t["role"].lower() in (role.lower(), "all")
            and t["section"].lower() == section.lower()
        ]
    ...
    def generate_cover_letter(self, role: str, company: str) -> dict:
        ...
        opening = next(
            (t for t in EXAMPLES if t["section"] == "Cover Letter Opening"), None
        )
        closing = next(
            (t for t in EXAMPLES if t["section"] == "Cover Letter Closing"), None
        )
    ...
    def run(self) -> dict:
        ...
        return {
            ...
            "sections": len(self.get_resume_sections()),
        }
