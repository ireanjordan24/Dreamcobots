...
EXAMPLES = [
    {
        ...
        "difficulty": "easy",
        "role": "all",
        "star_answer": "Start with your current role, highlight 2-3 key achievements, then explain why you're excited about this opportunity.",
        "follow_ups": [
    ...
    },
    {
        ...
        "difficulty": "easy",
        "role": "all",
        "star_answer": "Research the company's mission and recent achievements. Connect your personal values and career goals to their impact.",
        "follow_ups": ["What do you know about our products?"],
    },
    {
        "id": 3,
        ...
        "difficulty": "medium",
        "role": "all",
        "star_answer": "Choose a real weakness, describe steps you're taking to improve it, and show measurable progress.",
        "follow_ups": ["Can you give another example?"],
    },
    {
        "id": 4,
        "question": "Describe a time you led a team under pressure.",
        "type": "behavioral",
        "difficulty": "medium",
        "role": "management",
        "star_answer": "Situation: Product launch delayed. Task: Coordinate 5-person team. Action: Daily standups, clear ownership. Result: Launched on time, 15% over target.",
    ...
    },
    {
        ...
        "star_answer": "Discuss hash function (MD5/Base62), database schema (short_code→URL), cache layer (Redis), load balancing, and 301 vs 302 redirects.",
        "follow_ups": ["How would you handle 1B requests/day?"],
    },
    {
        "id": 6,
        ...
        "difficulty": "medium",
        "role": "ml_engineer",
        "star_answer": "Supervised: labeled data, learn input→output mapping (classification, regression). Unsupervised: no labels, find patterns (clustering, dimensionality reduction).",
        "follow_ups": ["Give a real-world example of each."],
    },
    {
        "id": 7,
        ...
        "star_answer": "Project free cash flows, select discount rate (WACC), calculate terminal value, discount all to present value, add non-operating assets.",
        "follow_ups": ["What are the key assumptions?"],
    },
    {
        "id": 8,
        "question": "How do you prioritize features on a roadmap?",
        "type": "behavioral",
        "difficulty": "medium",
        "role": "product_manager",
        "star_answer": "Use a framework: RICE (Reach×Impact×Confidence/Effort) or MoSCoW. Balance customer value, business goals, and technical feasibility.",
        "follow_ups": ["How do you handle stakeholder conflicts?"],
    },
    {
        "id": 9,
        "question": "How would you improve our conversion rate?",
        "type": "case",
        "difficulty": "hard",
        "role": "marketing_manager",
        "star_answer": "Audit current funnel, identify drop-off points (Google Analytics), A/B test landing pages, optimize CTA copy, improve page speed.",
        "follow_ups": ["What metrics would you track?"],
    },
    {
        "id": 10,
        ...
        "difficulty": "medium",
        "role": "all",
        "star_answer": "Use STAR. Choose a real failure, own your mistake, explain what you learned, and describe how you applied that lesson.",
        "follow_ups": ["What would you do differently?"],
    },
    {
        "id": 11,
        "question": "What is Big O notation? Give examples.",
        "type": "technical",
        "difficulty": "medium",
        "role": "software_engineer",
        "star_answer": "Time/space complexity measure. O(1) constant, O(log n) binary search, O(n) linear scan, O(n log n) merge sort, O(n²) nested loops.",
        "follow_ups": ["What's the complexity of your last project?"],
    },
    {
        "id": 12,
        "question": "How do you handle a difficult team member?",
        "type": "behavioral",
        "difficulty": "medium",
        "role": "management",
        "star_answer": "1-on-1 conversation, understand their perspective, set clear expectations, document if escalation needed, involve HR if necessary.",
        "follow_ups": ["What if they don't improve?"],
    },
    {
        "id": 13,
        ...
        "difficulty": "medium",
        "role": "software_engineer",
        "star_answer": "REST: fixed endpoints, multiple requests, over/under fetching. GraphQL: single endpoint, query exactly what you need, typed schema.",
        "follow_ups": ["When would you use each?"],
    },
    {
        "id": 14,
        "question": "How do you analyze a new market opportunity?",
        "type": "case",
        "difficulty": "hard",
        "role": "product_manager",
        "star_answer": "TAM/SAM/SOM sizing, competitive landscape, customer research, regulatory environment, business model viability, go-to-market strategy.",
        "follow_ups": ["How would you validate assumptions?"],
    },
    {
        "id": 15,
        "question": "What's your approach to cold email outreach?",
        "type": "behavioral",
        "difficulty": "medium",
        "role": "sales",
        "star_answer": "Research prospect pain points, personalize subject line, lead with value not features, clear CTA, follow-up 3x, A/B test copy.",
        "follow_ups": ["What's your average open rate?"],
    },
    {
        "id": 16,
        ...
        "difficulty": "hard",
        "role": "ml_engineer",
        "star_answer": "Optimization algorithm to minimize loss function. Calculate gradient (∂L/∂w), update weights: w = w - η∇L. Variants: SGD, Adam, RMSProp.",
        "follow_ups": ["How do you choose learning rate?"],
    },
    {
        "id": 17,
        "question": "How do you build a customer success playbook?",
        "type": "case",
        "difficulty": "medium",
        "role": "customer_success",
        "star_answer": "Map customer journey, define health score signals, create segment-specific playbooks (onboarding, QBR, at-risk, expansion), automate triggers.",
        "follow_ups": ["How do you measure success?"],
    },
    {
        "id": 18,
        "question": "Describe how you would debug a slow database query.",
        "type": "technical",
        "difficulty": "medium",
        "role": "software_engineer",
        "star_answer": "EXPLAIN ANALYZE, check missing indexes, look for N+1 queries, consider query rewriting, caching with Redis, or table partitioning.",
        "follow_ups": ["What profiling tools do you use?"],
    },
    {
        "id": 19,
        "question": "What metrics define success for a new product feature?",
        "type": "behavioral",
        "difficulty": "medium",
        "role": "product_manager",
        "star_answer": "Primary: adoption rate, retention impact. Secondary: NPS, support tickets, revenue attribution. Guardrail: performance regression, error rate.",
        "follow_ups": ["How long do you track a feature?"],
    },
    {
        "id": 20,
        ...
        "difficulty": "medium",
        "role": "all",
        "star_answer": "Clarify urgency vs importance (Eisenhower matrix), communicate trade-offs to stakeholders, negotiate timelines, and communicate proactively.",
        "follow_ups": ["Give me a specific example."],
    },
    {
        "id": 21,
        ...
        "difficulty": "medium",
        "role": "software_engineer",
        "star_answer": "TCP: connection-oriented, reliable, ordered, slower (web, email). UDP: connectionless, fast, no guarantee (video streaming, gaming, DNS).",
        "follow_ups": ["Which would you use for a chat app?"],
    },
    {
        "id": 22,
        "question": "How do you retain at-risk customers?",
        "type": "case",
        "difficulty": "hard",
        "role": "customer_success",
        "star_answer": "Detect signals early (usage drop, NPS dip, support tickets), proactive outreach, EBR, executive sponsor, personalized success plan.",
        "follow_ups": ["What's an acceptable churn rate for SaaS?"],
    },
    {
        "id": 23,
        "question": "What financial ratios do you use to evaluate a company?",
        "type": "technical",
        "difficulty": "medium",
        "role": "financial_analyst",
        "star_answer": "Profitability: ROE, EBITDA margin. Liquidity: current ratio, quick ratio. Leverage: D/E ratio. Efficiency: asset turnover. Valuation: P/E, EV/EBITDA.",
        "follow_ups": ["How do these differ by industry?"],
    },
    {
        "id": 24,
        ...
        "difficulty": "hard",
        "role": "ml_engineer",
        "star_answer": "Content-based: item features similarity. Collaborative filtering: user behavior matrix. Hybrid: combine both. Considerations: cold start, scalability, freshness.",
        "follow_ups": ["How do you evaluate it?"],
    },
    {
        "id": 25,
        "question": "Describe a data-driven decision you made.",
        "type": "behavioral",
        "difficulty": "medium",
        "role": "all",
        "star_answer": "Identified declining retention, analyzed cohort data in SQL, discovered feature under-adoption, drove targeted campaign, improved retention by 18%.",
        "follow_ups": ["How did you present your findings?"],
    },
    {
        "id": 26,
        "question": "How would you scale a system to handle 10x traffic?",
        "type": "technical",
        "difficulty": "hard",
        "role": "software_engineer",
        "star_answer": "Horizontal scaling, load balancing, database read replicas, CDN for static assets, caching (Redis/Memcached), async queues (Celery/RabbitMQ), autoscaling.",
        "follow_ups": ["What would you monitor?"],
    },
    {
        "id": 27,
        "question": "How do you negotiate a job offer?",
        "type": "behavioral",
        "difficulty": "medium",
        "role": "all",
        "star_answer": "Research market data (Glassdoor, Levels.fyi), anchor high but realistically, negotiate total comp (base, equity, bonus), get it in writing.",
        "follow_ups": ["What if they say no to your counter?"],
    },
    {
        "id": 28,
        ...
        "difficulty": "easy",
        "role": "all",
        "star_answer": "Be authentic but align with the company culture. Mention: collaboration, ownership, feedback culture, growth opportunities. Research their values.",
        "follow_ups": ["How do you handle remote work?"],
    },
    {
        "id": 29,
        ...
        "difficulty": "easy",
        "role": "all",
        "star_answer": "Specific: name 2-3 newsletters/podcasts/communities relevant to your role. Show genuine curiosity and how you apply new knowledge.",
        "follow_ups": ["What did you learn recently?"],
    },
    {
        "id": 30,
        ...
        "difficulty": "easy",
        "role": "all",
        "star_answer": "Always ask: 1) What does success look like in 90 days? 2) What's the biggest challenge the team faces? 3) How does the company support career growth?",
        "follow_ups": [],
    },
]
...
class InterviewPrepBot:
    ...
    def get_questions_by_role(self, role: str) -> list[dict]:
        ...
        return [
            q for q in self._available_questions() if q["role"] in (role.lower(), "all")
        ]
    ...
    def get_ai_coaching_feedback(self, question_id: int, user_answer: str) -> dict:
        ...
        if len(user_answer.split()) < 50:
            feedback["feedback"].append(
                "Your answer is too short. Aim for 2-3 minutes (150-200 words)."
            )
        else:
            feedback["feedback"].append("Good length! Your answer is well-developed.")
        has_result = any(
            w in user_answer.lower()
            for w in ["result", "outcome", "%", "$", "increased", "reduced"]
        )
        if not has_result:
            feedback["feedback"].append(
                "Add a quantifiable result (%, $, time saved) to strengthen your answer."
            )
        else:
            feedback["feedback"].append(
                "Great! You included a measurable result — this is exactly what interviewers want."
            )
    ...
    def get_prep_summary(self) -> dict:
        ...
        return {
            ...
            "avg_self_rating": (
                round(
                    sum(p["self_rating"] for p in self._practice_log)
                    / len(self._practice_log),
                    1,
                )
                if self._practice_log
                else 0
            ),
            "tier": self.tier,
        }
    ...
    def run(self) -> dict:
        ...
        return {
            ...
            "prep_summary": self.get_prep_summary(),
        }
