"""
OrderManagementBot — order tracking and management bot.
...
class OrderManagementBotTierError(Exception):
...
class OrderManagementBot:
    """Tier-aware order tracking and management bot."""
    ...
    def _enforce_tier(self, required_value: str) -> None:
        ...
        if order.index(self.tier.value) < order.index(required_value):
            raise OrderManagementBotTierError(
