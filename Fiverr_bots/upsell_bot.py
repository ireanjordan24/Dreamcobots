"""
UpsellBot — gig upsell and cross-sell bot.
...
class UpsellBotTierError(Exception):
...
class UpsellBot:
    """Tier-aware gig upsell and cross-sell bot."""
    ...
    def list_items(self, limit: Optional[int] = None) -> List[Dict[str, Any]]:
        """Return a list of upsell_bot items up to the tier limit."""
        self._usage_count += 1
    ...
    def get_top_item(self) -> Dict[str, Any]:
        """Return the highest-value upsell_bot item."""
        self._usage_count += 1
