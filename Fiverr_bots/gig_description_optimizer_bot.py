"""
GigDescriptionOptimizerBot — gig description SEO optimizer.
...
class GigDescriptionOptimizerBotTierError(Exception):
...
class GigDescriptionOptimizerBot:
    """Tier-aware gig description SEO optimizer."""
    ...
    def _enforce_tier(self, required_value: str) -> None:
        ...
        if order.index(self.tier.value) < order.index(required_value):
            raise GigDescriptionOptimizerBotTierError(
    ...
    def list_items(self, limit: Optional[int] = None) -> List[Dict[str, Any]]:
        """Return a list of gig_description_optimizer_bot items up to the tier limit."""
        self._usage_count += 1
    ...
    def get_top_item(self) -> Dict[str, Any]:
        """Return the highest-value gig_description_optimizer_bot item."""
        self._usage_count += 1
    ...
    def export_report(self) -> Dict[str, Any]:
        ...
        self._usage_count += 1
        return {
            "bot": "GigDescriptionOptimizerBot",
            "tier": self.tier.value,
