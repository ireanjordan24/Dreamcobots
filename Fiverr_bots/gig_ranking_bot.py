"""
GigRankingBot — gig search ranking optimizer.
...
class GigRankingBotTierError(Exception):
...
class GigRankingBot:
    """Tier-aware gig search ranking optimizer."""
    ...
    def list_items(self, limit: Optional[int] = None) -> List[Dict[str, Any]]:
        """Return a list of gig_ranking_bot items up to the tier limit."""
        self._usage_count += 1
    ...
    def get_top_item(self) -> Dict[str, Any]:
        """Return the highest-value gig_ranking_bot item."""
        self._usage_count += 1
