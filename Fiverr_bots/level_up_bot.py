"""
LevelUpBot — Fiverr seller level advancement bot.
...
class LevelUpBotTierError(Exception):
...
class LevelUpBot:
    """Tier-aware Fiverr seller level advancement bot."""
    ...
    def list_items(self, limit: Optional[int] = None) -> List[Dict[str, Any]]:
        """Return a list of level_up_bot items up to the tier limit."""
        self._usage_count += 1
    ...
    def get_top_item(self) -> Dict[str, Any]:
        """Return the highest-value level_up_bot item."""
        self._usage_count += 1
