...
class PluginRegistry:
    ...
    def _init_plugins(self):
        defaults = [
            Plugin(
                ...
                ["model selection", "cost optimization", "quality scoring"],
                5.0,
                1520,
                "DreamCo",
            ),
            Plugin(
                ...
                ["coupon stacking", "auto-apply", "savings tracker"],
                5.0,
                980,
                "DreamCo",
            ),
            Plugin(
                ...
                ["price alerts", "portfolio tracking", "multi-exchange"],
                4.0,
                740,
                "DreamCo",
            ),
            Plugin(
                ...
                ["push notifications", "email alerts", "SMS alerts"],
                5.0,
                2340,
                "DreamCo",
            ),
            Plugin(
                ...
                ["command handling", "auto moderation", "bot integration"],
                4.0,
                610,
                "DreamCo",
            ),
            Plugin(
                "flip_profit_calculator",
                "Flip Profit Calculator",
                PluginCategory.FINANCE,
                "v1.5.0",
                "Calculates profit margins and ROI for resale flipping",
                ["profit calculation", "ROI analysis", "fee estimation"],
                4.0,
                830,
                "DreamCo",
            ),
            Plugin(
                ...
                ["multi-platform sync", "stock tracking", "low stock alerts"],
                4.0,
                1100,
                "DreamCo",
            ),
            Plugin(
                ...
                ["OCR scanning", "cashback matching", "expense categorization"],
                5.0,
                1890,
                "DreamCo",
            ),
            Plugin(
                ...
                ["route planning", "fuel estimation", "ROI per stop"],
                4.0,
                450,
                "DreamCo",
            ),
            Plugin(
                ...
                ["keyword research", "content scoring", "competitor analysis"],
                4.0,
                670,
                "DreamCo",
            ),
            Plugin(
                "slack_workspace_plugin",
                "Slack Workspace Plugin",
                PluginCategory.INTEGRATION,
                "v1.3.0",
                "Connects AI bots to Slack workspaces for team automation",
                ["workspace integration", "channel notifications", "bot commands"],
                4.0,
                820,
                "DreamCo",
            ),
            Plugin(
                "telegram_bot_connector",
                "Telegram Bot Connector",
                PluginCategory.INTEGRATION,
                "v1.2.0",
                "Connects AI capabilities to Telegram bots",
                ["bot connection", "message handling", "inline commands"],
                4.0,
                590,
                "DreamCo",
            ),
    ...
    def get_top_rated(self, n: int = 5) -> list:
        return sorted(
            ...
            key=lambda p: (p.rating, p.install_count),
            reverse=True,
        )[:n]
