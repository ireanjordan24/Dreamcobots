...
_COMPANIES: List[AICompany] = [
    ...
    AICompany(
        company_name="Eleven Labs Clone",
        category="AI Voice & Audio",
        tools=["Voice Design", "SFX Generator", "Audio Native"],
        pricing="freemium",
        region="USA",
        api_available=True,
        description="AI audio platform for speech and sound effects generation.",
    ),
    # -----------------------------------------------------------------------
    # Additional notable companies (reaching 100+ total)
    # -----------------------------------------------------------------------
    ...
    AICompany(
        company_name="Mistral AI",
        category="European AI Leaders",
        tools=["Mistral 7B", "Mixtral 8x7B", "Le Chat", "Mistral Large"],
        pricing="token-based",
        region="Europe",
        api_available=True,
        description="European AI leader building efficient open-weight language models.",
    ),
    AICompany(
        company_name="Stability AI",
        category="European AI Leaders",
        tools=["Stable Diffusion", "Stable Audio", "Stable Video"],
        pricing="open-source",
        region="UK",
        api_available=True,
        description="Open-source generative AI company headquartered in the UK.",
    ),
    AICompany(
        company_name="Writer",
        category="AI Productivity Tools",
    ...
    AICompany(
        company_name="Pika Labs",
        category="AI Agents & Automation",
        tools=["Pika Automations", "Bot Templates"],
        pricing="freemium",
        region="USA",
        api_available=True,
