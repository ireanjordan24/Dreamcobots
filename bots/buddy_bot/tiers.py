...
FEATURE_COMMERCIAL_PRODUCTION = "commercial_production"
FEATURE_RADIO_AD_STUDIO = "radio_ad_studio"
FEATURE_VIDEO_AD_STUDIO = "video_ad_studio"
FEATURE_MUSIC_VIDEO_PRODUCTION = "music_video_production"
# Media Production (ENTERPRISE)
FEATURE_MOVIE_PRODUCTION = "movie_production"
FEATURE_AI_ONLY_ADS = "ai_only_ads"
FEATURE_CLIENT_ASSET_ADS = "client_asset_ads"

# Self-Learning / Continuous Training (PRO+)
FEATURE_SELF_LEARNING = "self_learning"
FEATURE_CAPABILITY_CHECK = "capability_check"
# Self-Learning / Continuous Training (ENTERPRISE)
FEATURE_TRAINING_SESSION = "training_session"
FEATURE_GITHUB_ACQUISITION = "github_acquisition"
FEATURE_TOP_MODEL_REGISTRY = "top_model_registry"
...
ENTERPRISE_FEATURES: list = PRO_FEATURES + [
    ...
    # Media Production (Enterprise-only)
    FEATURE_MOVIE_PRODUCTION,
    FEATURE_AI_ONLY_ADS,
    FEATURE_CLIENT_ASSET_ADS,
    # Self-Learning (Enterprise-only)
