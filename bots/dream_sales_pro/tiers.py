"""
Tier configuration for the DreamSalesPro Division.
...
@dataclass
class TierConfig:
    """Configuration for a DreamSalesPro subscription tier."""
...
FEATURE_OUTREACH_TOOLS = "outreach_tools"
FEATURE_PIPELINE_TOOLS = "pipeline_tools"
