 ...
 *
 * <p>All concrete Java event bus implementations (in-process, Redis-backed,
 * HTTP-based, etc.) must implement this interface so that bots remain decoupled
 * from the underlying transport.
 */
public interface EventBus {

    /**
     * Publish {@code eventType} with the given JSON {@code data} payload to all
