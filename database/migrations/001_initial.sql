-- DreamCo — Initial Migration (v1)
-- Wraps schema creation in a transaction with version tracking.
...
-- ──────────────────────────────────────────────────────────────────────────────
-- Seed default bot schedules
-- ──────────────────────────────────────────────────────────────────────────────
INSERT INTO bot_schedules (bot_name, schedule_cron, enabled) VALUES
    ('multi_source_lead_scraper', '0 * * * *',      TRUE),
    ('fiverr_auto_apply',         '0 */6 * * *',    TRUE),
    ('real_estate_scanner',       '0 8 * * *',      TRUE),
    ('crypto_trader',             '*/15 * * * *',   TRUE),
    ('grant_finder',              '0 6 * * 1',      TRUE)
